...
function TextEditor( {onChange} : { onChange : (e : ChangeEvent<HTMLTextAreaElement>) => void } ) {
    return (
        <div>
            <div
                className="w-full h-full bg-gray-100 mb-4 border border-gray-200 rounded-lg min-h-[400px]">
                <div
                    className="flex items-center justify-between px-3 py-3 border-b dark:border-gray-600">
                    <div
                        ...
                        <div
                            className="flex flex-wrap items-center space-x-1 rtl:space-x-reverse sm:ps-4">
                            <button
                                type="button"
                                className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                                <svg
                ...
                <div className="px-4 py-2 bg-gray-50 rounded-b-lg dark:bg-gray-800">
                    ...
                    onChange={onChange}
                        id="editor"
                        className="block focus:outline-none pl-2 pt-2 w-full h-[300px] px-0 text-sm text-gray-800 bg-0 border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
